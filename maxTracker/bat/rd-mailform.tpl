          ...
          <table align="center" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                    <td align="center" valign="top" style="padding: 0 20px;">
                      <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr> 
                          <td align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 14px; mso-line-height-rule: exactly; line-height: 22px; font-weight: 400;color: #302f35;">Hola, ¡Tienes un mensajes nuevo de un cliente! <!-- #{SiteName} --></td> 
                        </tr>
                        <tr> 
            ...
            <tr>
              <td width="600" align="center" valign="top">
                <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 12px; mso-line-height-rule: exactly; line-height: 18px; font-weight: 400;color: #a1b4c4;">Este mensaje se creo automáticamente, por favor no lo respondas.</td>
                  </tr>
                </table>
              </td>
            </tr>
